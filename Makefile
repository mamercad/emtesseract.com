...
install: deploy-files seed
	...
	sudo systemctl enable emtesseract-heartbeat emtesseract-worker emtesseract-content emtesseract-crawl emtesseract-bluesky emtesseract-roundtable emtesseract-api
	sudo systemctl restart emtesseract-heartbeat emtesseract-worker emtesseract-content emtesseract-crawl emtesseract-bluesky emtesseract-roundtable emtesseract-api
...
deploy-files:
	...
	sed 's|@PROJECT_ROOT@|$(PROJECT_ROOT)|g;s|@USER@|$(USER)|g' \
		systemd/emtesseract-bluesky.service.in > build/systemd/emtesseract-bluesky.service
	@echo "Generated build/systemd/*.service"

# Show service status
status:
	@systemctl is-active emtesseract-heartbeat emtesseract-worker emtesseract-content emtesseract-crawl emtesseract-bluesky emtesseract-roundtable emtesseract-api 2>/dev/null || true
	@sudo systemctl status emtesseract-heartbeat emtesseract-worker emtesseract-content emtesseract-crawl emtesseract-bluesky emtesseract-roundtable emtesseract-api --no-pager 2>/dev/null || true

# Stop services
stop:
	sudo systemctl stop emtesseract-heartbeat emtesseract-worker emtesseract-content emtesseract-crawl emtesseract-bluesky emtesseract-roundtable emtesseract-api
