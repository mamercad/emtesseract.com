...
description: Creates distinctive, production-grade frontend interfaces with high design quality. Use when building web components, pages, or applications, or when the user asks to create UI, frontend code, or web interfaces. Generates creative, polished code that avoids generic AI aesthetics.
---
